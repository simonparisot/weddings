...
var stripe_account = "acct_1SoVeDFedvmnXcz4";
...
// New function for direct donation payment from liste.html
function proceedToPayment() {

    var customprice = document.querySelector('#custom_price').value;
    var customtext = document.querySelector('#custom_text').value;

    // Validation
    if (!customprice || customprice <= 0) {
        alert("Merci d'indiquer un montant valide pour votre participation.");
        return;
    }

    var body = {
        product_img: 'https://eleonoreetmartial.fr/img/list/custom.webp',
        custom_price: parseInt(customprice, 10) * 100, // Convert to cents
        custom_name: 'Participation au voyage de noces',
        custom_text: customtext || 'Participation au voyage de noces',
        stripeaccount: stripe_account,
        successUrl: 'merci.html',
        cancelUrl: 'liste.html'
    };
...
// Legacy function for old-style gift list (kept for backward compatibility)
